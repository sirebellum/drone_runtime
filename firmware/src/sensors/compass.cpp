...
void COMPASS::run()
{
    while (this->running) {
        ...
        this->x = (float)this->merge_bytes(this->lower_byte, this->upper_byte)/65535;

        this->upper_byte = this->i2c->readByte(OUTPUT_Y_MSB_R);
        this->lower_byte = this->i2c->readByte(OUTPUT_Y_LSB_R);
        this->y = (float)this->merge_bytes(this->lower_byte, this->upper_byte)/65535;

        this->upper_byte = this->i2c->readByte(OUTPUT_Z_MSB_R);
        this->lower_byte = this->i2c->readByte(OUTPUT_Z_LSB_R);
        this->z = (float)this->merge_bytes(this->lower_byte, this->upper_byte)/65535;
