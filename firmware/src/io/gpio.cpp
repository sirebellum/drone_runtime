...
GPIO::GPIO() { this->gpionum = ""; }

GPIO::GPIO(string gnum) { this->gpionum = gnum; }

GPIO::GPIO(int gnum) { this->gpionum = to_string(gnum); }
...
void GPIO::setup(string gnum) { this->gpionum = gnum; }

void GPIO::setup(int gnum) { this->gpionum = to_string(gnum); }
...
int GPIO::export_gpio() {
  ...
  if (!exportgpio.is_open()) {
    LogHighLight::Log("OPERATION FAILED:", LogHighLight::FG_RED,
                      LogHighLight::BG_WHITE)
        << " ";
    LogHighLight::Log("Unable to export GPIO", LogHighLight::FG_YELLOW,
                      LogHighLight::BG_BLACK)
        << this->gpionum;
    cout << endl;
    return -1;
  }
...
int GPIO::unexport_gpio() {
  ...
  if (!unexportgpio.is_open()) {
    LogHighLight::Log("OPERATION FAILED:", LogHighLight::FG_RED,
                      LogHighLight::BG_WHITE)
        << " ";
    LogHighLight::Log("Unable to unexport GPIO", LogHighLight::FG_YELLOW,
                      LogHighLight::BG_BLACK)
        << this->gpionum;
    cout << endl;
    return -1;
...
int GPIO::close() { return this->unexport_gpio(); }
...
int GPIO::setdir_gpio(string dir) {
  ...
  if (!setdirgpio.is_open()) {
    LogHighLight::Log("OPERATION FAILED:", LogHighLight::FG_RED,
                      LogHighLight::BG_WHITE)
        << " ";
    LogHighLight::Log("Unable to set direction of GPIO",
                      LogHighLight::FG_YELLOW, LogHighLight::BG_BLACK)
        << this->gpionum;
    cout << endl;
    return -1;
  }
...
int GPIO::setval_gpio(string val) {
  ...
  if (!setvalgpio.is_open()) {
    LogHighLight::Log("OPERATION FAILED:", LogHighLight::FG_RED,
                      LogHighLight::BG_WHITE)
        << " ";
    LogHighLight::Log("Unable to set value of GPIO", LogHighLight::FG_YELLOW,
                      LogHighLight::BG_BLACK)
        << this->gpionum;
    cout << endl;
    return -1;
...
int GPIO::get() {
  ...
  if (!getvalgpio.is_open()) {
    LogHighLight::Log("OPERATION FAILED:", LogHighLight::FG_RED,
                      LogHighLight::BG_WHITE)
        << " ";
    LogHighLight::Log("Unable to get value of GPIO", LogHighLight::FG_YELLOW,
                      LogHighLight::BG_BLACK)
        << this->gpionum;
    cout << endl;
    return -1;
...
string GPIO::get_gpionum() { return this->gpionum; }

int GPIO::get_igpionum() { return atoi(this->gpionum.c_str()); }
