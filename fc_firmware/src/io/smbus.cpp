...
__s32 i2c_smbus_write_byte(int file, __u8 value) {
  return i2c_smbus_access(file, I2C_SMBUS_WRITE, value, I2C_SMBUS_BYTE,
                          nullptr);
}
...
__s32 i2c_smbus_read_byte_data(int file, __u8 command) {
  ...
  err = i2c_smbus_access(file, I2C_SMBUS_READ, command, I2C_SMBUS_BYTE_DATA,
                         &data);
  if (err < 0)
    return err;
...
__s32 i2c_smbus_read_word_data(int file, __u8 command) {
  ...
  err = i2c_smbus_access(file, I2C_SMBUS_READ, command, I2C_SMBUS_WORD_DATA,
                         &data);
  if (err < 0)
    return err;
...
__s32 i2c_smbus_read_block_data(int file, __u8 command, __u8 *values) {
  ...
  err = i2c_smbus_access(file, I2C_SMBUS_READ, command, I2C_SMBUS_BLOCK_DATA,
                         &data);
  if (err < 0)
    return err;
