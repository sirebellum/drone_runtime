...
void IR::MLX90640_CalculateTo(uint16_t *frameData, const paramsMLX90640 *params,
...
void IR::MLX90640_GetImage(uint16_t *frameData, const paramsMLX90640 *params,
                           float *result) {
  float vdd;
  float ta;
  float gain;
...
//------------------------------------------------------------------------------
void IR::MLX90640_BadPixelsCorrection(uint16_t *pixels, float *to, int mode,
