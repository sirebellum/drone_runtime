...
// The subset of the TVM runtime API that is implemented by the minimal runtime
// API.

#define TVM_MICRO_RUNTIME_API_BACKEND_API                                      \
  extern "C" __attribute__((weak, visibility("default")))

TVM_MICRO_RUNTIME_API_BACKEND_API int
TVMBackendFreeWorkspace(int device_type, int device_id, void *ptr);

TVM_MICRO_RUNTIME_API_BACKEND_API void *
TVMBackendAllocWorkspace(int device_type, int device_id, uint64_t nbytes,
